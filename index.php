...
<head>
	...
	<meta name="og:url" content="https://matheus.sgomes.dev/">
...
<body>
	...
	<div class="page" id="home-section">
		...
		<div class="started-bg">
			<div class="slide" style="    background-image: url(img/header-bg.jpg);background-position: bottom;"></div>
		</div>
						...
						<div class="row">
							...
							<div class="col col-m-12 col-t-7 col-d-7">
								<div class="text-box">
									...
									<p>
										Sou um apaixonado do mundo do Desenvolvimento, e principalmente por desafios que me fazem evoluir e aprender coisas novas.
										E sempre estudo para ou melhorar minhas habilidades atuais, ou para aprender uma nova.
									</p>
								</div>
								<div class="bts">
						...
						<div class="cd-timeline-block animated">
							...
							<div class="cd-timeline-content">
								<div class="content-box">
									...
									<div class="name">MongoDB Basics</div>
									<div class="category">MongoDB University</div>
								</div>
							</div>
						</div>
						<div class="cd-timeline-block animated">
							...
							<div class="cd-timeline-content">
								<div class="content-box">
									<div class="date">2017 - 2018</div>
									<div class="name">Diversos Cursos</div>
									<div class="category">Alura</div>
									<p>
										<ul>
											<li>PHP e MySQL I</li>
											<li>PHP e MySQL II</li>
											<li>PHP I</li>
											<li>PHP II</li>
											<li>PHP III</li>
											<li>MySQL I</li>
						...
						<div class="cd-timeline-block animated">
							...
							<div class="cd-timeline-content">
								<div class="content-box">
									...
									<div class="name">PHP Orientado a Objeto</div>
									<div class="category">UpInside Treinamentos</div>
								</div>
							</div>
						</div>
						<div class="cd-timeline-block animated">
							...
							<div class="cd-timeline-content">
								<div class="content-box">
									...
									<div class="name">Bacharelado em Sistemas de Informação</div>
									<div class="category">Faculdade Pitágoras</div>
								</div>
							</div>
						</div>
						<div class="cd-timeline-block animated">
							...
							<div class="cd-timeline-content">
								<div class="content-box">
									...
									<div class="name">Desenvolvimento PHP</div>
									<div class="category">Codecademy</div>
								</div>
							</div>
						</div>
						<div class="cd-timeline-block animated">
							...
							<div class="cd-timeline-content">
								<div class="content-box">
									<div class="date">2014</div>
									<div class="name">Treinamento Java </div>
									<div class="category">Stefanini</div>
								</div>
							</div>
						</div>
						<div class="cd-timeline-block animated">
							...
							<div class="cd-timeline-content">
								<div class="content-box">
									...
									<div class="category">CNI – Centro Nacional de Informatica</div>
								</div>
							</div>
						</div>
					</div>
